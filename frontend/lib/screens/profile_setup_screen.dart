...
class _ProfileSetupScreenState extends State<ProfileSetupScreen> {
  ...
  Future<void> _saveAndContinue() async {
    ...
    if (_heightCtrl.text.isNotEmpty) {
      await prefs.setDouble('height', double.tryParse(_heightCtrl.text) ?? 0);
    }

    if (_weightCtrl.text.isNotEmpty) {
      await prefs.setDouble('weight', double.tryParse(_weightCtrl.text) ?? 0);
    }
        ...
        children: [
          ...
          Expanded(
            child: PageView(
              ...
              children: [_page1BasicInfo(), _page2Gender()],
            ),
          ),
